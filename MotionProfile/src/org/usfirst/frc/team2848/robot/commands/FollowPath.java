...
public class FollowPath extends Command {
    ...
    protected void initialize() {
    	...
    	m_startEncoderLeft = Robot.getDriveTrain().getEncoderLeft();
    	m_startEncoderRight = Robot.getDriveTrain().getEncoderRight();
    ...
    protected void execute() {
    	...
    	/*else if(m_backwards && m_finalPositionRight >= Robot.getDriveBaseSimple().getEncoderRight() && m_finalPositionLeft >= Robot.getDriveBaseSimple().getEncoderLeft()){
    	...
    	else
        	{
        		...
        		int realLeftEncoder = Robot.getDriveTrain().getEncoderLeft();
        		int realRightEncoder = Robot.getDriveTrain().getEncoderRight();
        		...
        		Robot.getDriveTrain().setLeftMotor(leftMotorLevel);
        		Robot.getDriveTrain().setRightMotor(rightMotorLevel);
